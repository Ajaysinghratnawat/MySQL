-- Self join -> when table join by itself
...
select emp.emp_id,emp.emp_name,emp.salary,emp.manager_id,man.emp_name,man.salary
from employee as emp join employee as man
where emp.manager_id=man.emp_id;

select emp.emp_id,emp.emp_name,emp.salary,emp.manager_id,man.emp_name,man.salary
from employee as emp join employee as man
where emp.manager_id=man.emp_id and emp.salary>man.salary;
